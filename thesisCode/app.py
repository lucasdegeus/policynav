...
pinterest = open("/home/thesis/myproject/policynav/thesisCode/policies/pinterest.txt",encoding="utf8").read()
reddit = open("/home/thesis/myproject/policynav/thesisCode/policies/reddit.txt",encoding="utf8").read()
linkedin = open("/home/thesis/myproject/policynav/thesisCode/policies/linkedin.txt",encoding="utf8").read()
yahoo = open("/home/thesis/myproject/policynav/thesisCode/policies/yahoo.txt",encoding="utf8").read()
spotify = open("/home/thesis/myproject/policynav/thesisCode/policies/spotify.txt",encoding="utf8").read()
tumblr = open("/home/thesis/myproject/policynav/thesisCode/policies/tumblr.txt",encoding="utf8").read()
snapchat = open("/home/thesis/myproject/policynav/thesisCode/policies/snapchat.txt",encoding="utf8").read()
flickr = open("/home/thesis/myproject/policynav/thesisCode/policies/flickr.txt",encoding="utf8").read()
telegram = open("/home/thesis/myproject/policynav/thesisCode/policies/telegram.txt",encoding="utf8").read()
########################################################################
whatsapp = open("/home/thesis/myproject/policynav/thesisCode/policies/whatsapp.txt",encoding="utf8").read()
facebook = open("/home/thesis/myproject/policynav/thesisCode/policies/facebook.txt",encoding="utf8").read()
twitter = open("/home/thesis/myproject/policynav/thesisCode/policies/twitter.txt",encoding="utf8").read()
instagram = open("/home/thesis/myproject/policynav/thesisCode/policies/instagram.txt",encoding="utf8").read()
google = open("/home/thesis/myproject/policynav/thesisCode/policies/google.txt",encoding="utf8").read()
...
jsonfile = open('/home/thesis/myproject/policynav/thesisCode/json.json')
...
def mainIndex():
    ...
    policies = []
    for policy in os.listdir('/home/thesis/myproject/policynav/thesisCode/policies'):
...
def add_numbers():
    ...
    policycontent = open("/home/thesis/myproject/policynav/thesisCode/policies/" + c + ".txt",encoding="utf8").read()
    return jsonify(policycontent)

@app.route('/checkContent')
def checkContent():
    c = request.args.get('policy')
    cleantext = BeautifulSoup(c, "lxml").text
    text = returnCategories(cleantext)
    if text == False:
